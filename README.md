...
## Website https://hypersoftwaregroup.github.io/hyperfortnitebooster/
...
## Run Setup
### Inside the zip folder, locate the "setup.exe" file. Double-click it to start the setup process.
